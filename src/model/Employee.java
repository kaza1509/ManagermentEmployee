...
public class Employee implements Comparable<Employee> {
    ...
    public Employee(String id, String firstName, String lastName, String phone,
                    String email, String address, String dob, String sex, double salary, String agency) {
        this.id = id;
    ...
    public String toString() {
        ...
        String fullName = sb.append(" ").append(lastName).toString();
        return String.format("%-10s%-25s%-15s%-15s%-15s%-15s%-15s%-10s%-15s",
                id, fullName, phone, email, address, dob, sex, salary, agency);
    }
